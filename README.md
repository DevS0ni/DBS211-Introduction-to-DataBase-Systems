...
```
  * introduce students to data management concepts, database systems and database application programming.
  * learn to represent information with a relational database model and manipulate data with an interactive
    query language.
  ...
  * Gained a handsome knowledge on all of the topics of Introduction to DataBase Systems namely-
...
* Relational Model - 5%
    * File-based (file, record, field) versus Data Model (entity, attribute,
      relationship) versus Relational Model (relation, tuple, attribute)
      versus Relational database (table, row, column)
...
* Database Modeling and Design - 15%
    ...
    * Applying high level conceptual models (Entity Relationship Diagram) for Database
      design (entity/relation sets, attribute sets, keys)
...
* Structured Query Language(SQL) Overview - 25%
    ...
    * Preserve database integrity using constraints NOT NULL, CHECK,
      UNIQUE, PRIMARY KEY and FOREIGN KEY constraint
* Physical Database Design - 10%
    * Identify views, security, integrity constraints, and additional constraints:
      uniqueness, mandatory/optional, default value, validation criteria
...
understand the aspects of Introduction to DataBase System Concepts and it's topic
